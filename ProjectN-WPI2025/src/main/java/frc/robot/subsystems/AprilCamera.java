...
public class AprilCamera extends SubsystemBase {
   ...
   */
   double getHeight(){
    targetPose = aprilTagFieldLayout.getTagPose(target.fiducialId);  // TODO: MrG says it is dangerous to bury important
    truePose = targetPose.get();                                     //       functionality in this sort of method.
                                                                     //       Better to put it where it belongs; periodic()
 ...
 /* public EstimatedRobotPose getPoseTrue(){
  ...
  public void periodic() {
    ...
    camH = SmartDashboard.getNumber("CamHeight,in", Units.metersToInches(Constants.CamConstants.camera_Height_Meters));
    camPit = SmartDashboard.getNumber("CamPitch,deg", Units.radiansToDegrees(Constants.CamConstants.camera_Pitch_Radians));
