...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    try {
       ...
       testResults = new BufferedWriter(new FileWriter("/home/lvuser/Experiment.csv"));
       testResults.write("height, pitch, TarYaw, CamYaw, dist, output yaw, pitch, area, number of tags, relx, rely, relPitch, x,y,heading, dx,dy,dhead, areadist\n");
       testResults.flush();
       System.out.println("FIle Created");
    } catch (IOException e) {
      System.out.println("Write experiment results where? Not");
  ...
  private void printExper() {
   try {
    ...
    testResults.write(
      String.format("%5.3f ,",SmartDashboard.getNumber("CamHeight_i,in",-999.) 
          + Math.sin(SmartDashboard.getNumber("CamPitch_i,deg",-999.)) 
          + 1.55* Math.cos(SmartDashboard.getNumber("CamPitch_i,deg",-999.))
          + 3.5625)      // 
      +String.format("%5.3f ,",SmartDashboard.getNumber("CamPitch_i,deg",-999.))
      +String.format("%5.3f ,",SmartDashboard.getNumber("TargetYaw_i,deg",-999.))
      +String.format("%5.3f ,",SmartDashboard.getNumber("CamYaw_i,deg",-999.))
      +String.format("%5.3f ,",SmartDashboard.getNumber("PhysicalDist_i,in",-999.))
      ...
      +String.format("%5.3f ,",SmartDashboard.getNumber("Number of Targets", -999.))
      //+String.format("%5.3f ,",SmartDashboard.getNumber("targetID",-999.))
      +String.format("%5.3f ,",SmartDashboard.getNumber("RawX",-999.))
      +String.format("%5.3f ,",SmartDashboard.getNumber("RawY",-999.))
      +String.format("%5.3f ,",SmartDashboard.getNumber("RawPitch",-999.))
      +String.format("%5.3f ,",SmartDashboard.getNumber("ProcessedX",-999.))
      +String.format("%5.3f ,",SmartDashboard.getNumber("ProcessedY",-999.))
      +String.format("%5.3f ,",SmartDashboard.getNumber("Processed_Heading",-999.))
      +String.format("%5.3f ,",SmartDashboard.getNumber("deltaX",-999.))
      +String.format("%5.3f ,",SmartDashboard.getNumber("deltaY",-999.))
      +String.format("%5.3f ,",SmartDashboard.getNumber("deltaHeading",-999.))
      +String.format("%5.3f ",SmartDashboard.getNumber("Area Distance",-999.))
      +String.format("%d\n", dataCount++)
    );
    testResults.flush();
    System.out.println("writing happened");
    SmartDashboard.putNumber("Ndata", dataCount);
   }catch (IOException e) {
  ...
  public void configureButtonBindings() {
    ...
    new JoystickButton(driverJoytick, 3)
      .onTrue(new InstantCommand(() -> april.createPoseEstimator())
      .andThen(new InstantCommand(()-> System.out.println("poseEstimator updated"))));
