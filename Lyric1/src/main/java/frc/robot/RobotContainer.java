...
import frc.robot.commands.ExampleDefCommand;
...
public class RobotContainer {
  ...
  private XboxController controller = m_driverController.getHID();
  ...
  private void configureBindings() {
    ...
    m_exampleSubsystem.setDefaultCommand(new ExampleDefCommand(m_exampleSubsystem, controller));
